...
<body>
    <div class="container">
        <div class="header">
            <img src="logoouter.gif" alt="Logo">
        </div>
        ...
        $all_produk = array(
            ...
            array(
                'id' => 3,
                'jenis' => 'Front Band Outer',
                'foto' => 'front_band_outer.jpg',
                'harga' => 250000,
                'diskon' => false,
                'deskripsi' => 'Outer dengan desain Front Band yang trendi dan nyaman dipakai. Tambahkan sentuhan kasual pada gayamu sehari-hari dengan outer yang satu ini.'
            ),
            array(
                'id' => 4,
                'jenis' => 'Knitted Outer With Small Flowers',
                'foto' => 'knitted_outer_with_small_flowers.jpg',
                'harga' => 300000,
                'diskon' => false,
                'deskripsi' => 'Rasakan kehangatan dan kelembutan Knitted Outer ini dengan tambahan detail bunga-bunga kecil yang menawan. Pilihan yang sempurna untuk musim sejuk.'
            ),
            array(
                'id' => 5,
                'jenis' => 'Purple Cherry Blossoms',
                'foto' => 'purple_cherry_blossoms.jpg',
                'harga' => 350000,
                'diskon' => false,
                'deskripsi' => 'Tampil memukau dengan Purple Cherry Blossoms, busana dengan motif bunga sakura unik berwarna ungu. Cocok untuk gaya kasual yang tetap fashionable.'
            ),
        );
        ?>
